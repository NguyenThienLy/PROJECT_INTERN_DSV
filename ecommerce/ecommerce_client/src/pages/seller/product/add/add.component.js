...
export function ProductAdd({
    ...
    const handleFormSubmit = async (e) => {
        ...
        // if (!product.creating &&
        //     product.isCreateSuccess &&
        //     product.createError === null) {
        //     setInputValue(initialInputValue);
        //     message.success({ content: 'Create product success!', keyMessage, duration: 2 });
        // }
        // else if (!product.creating &&
        //     !product.isCreateSuccess &&
        //     product.createError !== null) {
        //     message.error({ content: 'Create product fail!', keyMessage, duration: 2 });
        // }
    }
